  ...
  <footer class="inserted-footer">
    <div class="container">
      <div class="footer-container">
        ...
        <div class="arrow-up" @click="scrollToTop" v-if="isHomePage">
          <img src="@/assets/img/arrow-up.svg" loading="lazy" alt="" class="animate-bounce cursor-pointer" />
        </div>
